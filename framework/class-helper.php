...
if ( ! class_exists( 'Businext_Helper' ) ) {
	class Businext_Helper {
		 ...
		 */
		public static function get_all_menus( $args = array() ) {
			$defaults = array(
				'default' => true,
				'empty'   => false,
			);
			...
			$menus   = get_terms( 'nav_menu', $term_args );
			$results = array();
			...
			if ( isset( $args['empty'] ) && $args['empty'] === true ) {
				$results['none'] = esc_html__( 'None', 'businext' );
			}
		...
		public static function get_top_bar_list( $default_option = false ) {
			...
			$results = array(
				...
				'07'   => esc_attr__( 'Top Bar 07', 'businext' ),
			);
		...
		public static function get_header_list( $default_option = false ) {
			...
			$headers = array(
				...
				'21'   => esc_attr__( 'Header 21', 'businext' ),
				'22'   => esc_attr__( 'Header 22', 'businext' ),
			);
