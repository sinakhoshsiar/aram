...
if ( ! class_exists( 'Businext_Enqueue' ) ) {
	class Businext_Enqueue {
		...
		public function enqueue() {
			...
			// Remove Rev Slider plugin resources have identical contents, but are served from different URLs.
			wp_dequeue_script( 'revmin-migration' );
			...
			wp_register_style( 'lightgallery', BUSINEXT_THEME_URI . '/assets/libs/lightGallery/css/lightgallery.min.css', null, '1.6.12' );
			wp_register_script( 'lightgallery', BUSINEXT_THEME_URI . "/assets/libs/lightGallery/js/lightgallery-all{$min}.js", array(
				'jquery',
			), '1.6.12', true );

			wp_register_style( 'swiper', BUSINEXT_THEME_URI . '/assets/libs/swiper/css/swiper.min.css', null, '4.5.0' );
			wp_register_script( 'swiper', BUSINEXT_THEME_URI . "/assets/libs/swiper/js/swiper{$min}.js", array( 'jquery' ), '4.5.0', true );
	...
	Businext_Enqueue::instance()->init();
}
