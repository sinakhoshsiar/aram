	...
	'params'          => array_merge( array(
		array(
			...
			'value'       => array(
				...
				esc_html__( 'With Separator 01', 'businext' )         => 'border',
				esc_html__( 'With Separator 02', 'businext' )         => 'separator',
				esc_html__( 'With Light Border', 'businext' )      => 'light-border',
				esc_html__( 'With Dark Border', 'businext' )       => 'dark-border',
				esc_html__( 'Rounded Solid', 'businext' )          => 'rounded-solid',
				esc_html__( 'Rounded With Border', 'businext' )    => 'rounded-separator',
				esc_html__( 'Rounded With Border 02', 'businext' ) => 'rounded-separator-02',
			),
			'std'         => '',
		),
		array(
