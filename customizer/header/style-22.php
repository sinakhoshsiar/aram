...
Businext_Kirki::add_field( 'theme', array(
	...
	'output'      => array(
		...
		array(
			'element'  => '.desktop-menu .header-22 .header-right > div',
...
Businext_Kirki::add_field( 'theme', array(
	...
	'section'     => $section,
	'priority'    => $priority++,
	'default'     => '0 5px 10px rgba(0, 0, 0, 0.06)',
	'output'      => array(
		array(
			'element'  => '.header-22 .page-header-inner',
			'property' => 'box-shadow',
...
Businext_Kirki::add_field( 'theme', array(
	...
	'output'      => array(
		array(
			'element' => '.header-22.headroom--not-top .page-header-inner',
		),
	),
) );
...
Businext_Kirki::add_field( 'theme', array(
	...
	'output'      => array(
		...
		array(
			'element'  => '.header-22.headroom--not-top .branding',
			'property' => 'border-right-color',
		),
		array(
			'element'  => '.header-22.headroom--not-top .header-right-info',
			'property' => 'border-left-color',
		),
	),
) );
